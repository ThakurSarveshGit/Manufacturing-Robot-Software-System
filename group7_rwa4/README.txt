...
The attached Architecture.pdf contains the architecture diagram and its explanation. 
The attached Architecture.pdf also contains the flow diagram and its expalnation. 
